...
const Button = ({ children, variant = 'primary', className = '', type = 'button', disabled = false, onClick, ...props }) => {
  ...
  const variants = {
    primary: "bg-red-600 hover:bg-red-500 text-white shadow-lg shadow-red-500/20 hover:shadow-red-500/40 disabled:bg-red-600/60 disabled:cursor-not-allowed",
    ...
    outline: "bg-transparent border border-red-600 text-red-500 hover:bg-red-600/10 disabled:opacity-60 disabled:cursor-not-allowed",
