      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl text-center">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-slate-400 mb-8">
              Sua conta foi ativada com sucesso. VocÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âª jÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ pode fazer login.
            </p>
        ...
        {status === 'error' && (
          <>
            ...
            <h2 className="text-2xl font-bold text-white mb-4">Falha na VerificaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o</h2>
            <p className="text-slate-400 mb-8">
              O link ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© invÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lido ou expirou. Tente se cadastrar novamente ou entre em contato com o suporte.
            </p>
