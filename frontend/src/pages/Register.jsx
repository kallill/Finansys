      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl text-center">
          ...
          <p className="text-slate-400 mb-8">
            Enviamos um link de confirmaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o para <strong>{formData.email}</strong>. 
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl relative z-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-400">Comece a gerenciar suas finanÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§as hoje.</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-400 text-sm">
            JÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ tem uma conta? <button onClick={() => navigate('/login')} className="text-emerald-400 hover:underline">Fazer Login</button>
          </p>
        </div>
