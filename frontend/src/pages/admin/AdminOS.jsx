...
const mockOSData = [
  { id: 1, cliente: 'Agrobusiness Corp', desc: 'InstalaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o de Servidores', status: 'Em Andamento', data: '16/04/2026', anexos: [] },
  { id: 2, cliente: 'Tech Startups SA', desc: 'Consultoria Cloud', status: 'ConcluÃƒÆ’Ã‚Â­da', data: '12/04/2026', anexos: ['https://cerasus.com.br/uploads/os/fake1.jpg'] },
];
...
const AdminOS = () => {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      // SimulaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o para UX
      setTimeout(() => {
  ...
  return (
    <AdminLayout title="GestÃƒÆ’Ã‚Â£o de Ordens de ServiÃƒÆ’Ã‚Â§o (OS)">
        ...
        <table className="w-full text-left text-sm text-gray-400">
          <thead className="bg-gray-800/50 text-gray-300 font-medium">
            <tr>
              ...
              <th className="px-6 py-4">DescriÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o do ServiÃƒÆ’Ã‚Â§o</th>
              <th className="px-6 py-4">Status</th>
              <th className="px-6 py-4">Data</th>
              <th className="px-6 py-4 text-right">AÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o</th>
            </tr>
          </thead>
              ...
              <tr key={os.id} className="hover:bg-gray-800/30 transition-colors">
                ...
                <td className="px-6 py-4">
                  <span className={`px-2.5 py-1 rounded-full text-xs font-medium border
                    ${os.status === 'ConcluÃƒÆ’Ã‚Â­da' ? 'bg-green-500/10 text-green-400 border-green-500/20' : ''}
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-gray-900 h-full shadow-2xl border-l border-gray-800 overflow-y-auto flex flex-col">
            ...
            <div className="p-6 border-b border-gray-800 flex justify-between items-center sticky top-0 bg-gray-900/90 backdrop-blur-md z-10">
              ...
              <button onClick={closeMenu} className="text-gray-400 hover:text-white">ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¢</button>
            </div>
            ...
            <div className="p-6 flex-1">
              ...
              <div className="mb-6">
                <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">DescriÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o</p>
              ...
              <div className="mt-8 border-t border-gray-800 pt-6">
                <h4 className="text-sm font-medium text-white mb-4 flex items-center gap-2">
                  <ImageIcon size={16} />
                  Anexos e ComprovaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes
                </h4>
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-700 rounded-xl cursor-pointer hover:bg-gray-800/50 hover:border-red-500 transition-colors">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      ...
                      <p className="mb-2 text-sm text-gray-400 text-center px-4">
                        {uploading ? 'Enviando imagem...' : <><span className="font-semibold text-red-500">Clique para enviar</span> ou arraste a foto do serviÃƒÆ’Ã‚Â§o aqui</>}
                      </p>
                    </div>
