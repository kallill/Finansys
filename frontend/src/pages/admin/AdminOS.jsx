...
import { Briefcase, UploadCloud, CheckCircle, Image as ImageIcon, X } from 'lucide-react';
import AdminLayout from '../../components/admin/AdminLayout';
import api from '../../services/api';

// Fake Data for visual representation currently. 
const mockOSData = [
  { id: 1, cliente: 'Agrobusiness Corp', desc: 'Instalacao de Servidores', status: 'Em Andamento', data: '16/04/2026', anexos: [] },
  { id: 2, cliente: 'Tech Startups SA', desc: 'Consultoria Cloud', status: 'Concluida', data: '12/04/2026', anexos: [] },
];
        ...
        <table className="w-full text-left text-sm text-gray-400">
          <thead className="bg-gray-800/50 text-gray-300 font-medium">
            <tr>
              ...
              <th className="px-6 py-4">Descricao do Servico</th>
              ...
              <tr key={os.id} className="hover:bg-gray-800/30 transition-colors">
                ...
                <td className="px-6 py-4">
                  <span className={`px-2.5 py-1 rounded-full text-xs font-medium border
                    ${os.status === 'Concluida' ? 'bg-green-500/10 text-green-400 border-green-500/20' : ''}
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-gray-900 h-full shadow-2xl border-l border-gray-800 overflow-y-auto flex flex-col">
            ...
            <div className="p-6 flex-1">
              ...
              <div className="mb-6">
                <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">Descricao</p>
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-700 rounded-xl cursor-pointer hover:bg-gray-800/50 hover:border-red-500 transition-colors">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      ...
                      <p className="mb-2 text-sm text-gray-400 text-center px-4">
                        {uploading ? 'Enviando imagem...' : <><span className="font-semibold text-red-500">Clique para enviar</span> ou arraste a foto do servico aqui</>}
                      </p>
                    </div>
