    ...
    <AdminLayout title={title}>
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-white">
          MÃƒÆ’Ã‚Â³dulo em Desenvolvimento
        </h2>
        <p className="text-gray-400 max-w-md text-lg leading-relaxed">
          O mÃƒÆ’Ã‚Â³dulo de <span className="text-red-500 font-semibold">{title}</span> estÃƒÆ’Ã‚Â¡ sendo preparado para oferecer a melhor experiÃƒÆ’Ã‚Âªncia operacional da Cerasus.
        </p>
