...
function extractLocal(phrase) {
    ...
    // Tentativa de pegar a descriÃƒÂ§ÃƒÂ£o (o que sobrar tirando verbos e valores)
    let description = phrase
        .replace(amountRegex, '')
        .replace(/gastei|paguei|recebi|lanÃƒÂ§ar|fui|no|na|de|do|da|com|por/gi, '')
        .trim();
