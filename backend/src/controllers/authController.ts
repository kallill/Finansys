...
export const register = async (req: Request, res: Response) => {
  try {
    ...
    // Tenta enviar email de verifica̤̣o (ṇo-bloqueante: se falhar, conta ̩ criada assim mesmo)
    try {
      await sendVerificationEmail(email, verificationToken);
    } catch (emailError) {
      console.warn('Aviso: falha ao enviar email de verifica̤̣o (conta criada mesmo assim):', emailError);
    }
